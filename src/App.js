...
const sectionsData = [
  ...
  },
  {
    ...
    cards: [
      {
        icon: 'image',
        image_url: 'https://uws.njit.edu/ldapimage.php?format=full&uid=cpb26',
      ...
      {
        icon: 'image',
        image_url: 'https://uws.njit.edu/ldapimage.php?format=full&uid=nak44',
      ...
      {
        icon: 'image',
        image_url: 'https://uws.njit.edu/ldapimage.php?format=full&uid=cervelli',
      ...
      {
        icon: 'image',
        image_url: 'https://uws.njit.edu/ldapimage.php?format=full&uid=clarke👤',
      ...
      {
        icon: 'image',
        image_url: 'https://uws.njit.edu/ldapimage.php?format=full&uid=np858',
        title: 'Nayelli Perez',
      ...
      {
        icon: 'image',
        image_url: 'https://uws.njit.edu/ldapimage.php?format=full&uid=sims',
        title: 'Deborah Sims',
      ...
      {
        icon: 'image',
        image_url: 'https://uws.njit.edu/ldapimage.php?format=full&uid=jp2474',
        title: 'Janelle Pyar',
      ...
      {
        icon: 'image',
        image_url: 'https://uws.njit.edu/ldapimage.php?format=full&uid=ay394',
        title: 'AJ Yurista',
        description: 'Events where AJ is involved / volunteering',
        link: 'https://sharing.clickup.com/90132059689/l/h/2ky4m5h9-4553/bb9ac3de6b480a9',
      },
    ],
  },
];
